...
from mx_platform_python.models.split_transactions_response_body import SplitTransactionsResponseBody  # noqa: E501

class TestSplitTransactionsResponseBody(unittest.TestCase):
    """SplitTransactionsResponseBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SplitTransactionsResponseBody:
        """Test SplitTransactionsResponseBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SplitTransactionsResponseBody`
        """
        model = SplitTransactionsResponseBody()  # noqa: E501
        if include_optional:
            return SplitTransactionsResponseBody(
                transactions = [
                    mx_platform_python.models.transaction_response.TransactionResponse(
    ...
    def testSplitTransactionsResponseBody(self):
        """Test SplitTransactionsResponseBody"""
