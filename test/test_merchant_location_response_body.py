...
from mx_platform_python.models.merchant_location_response_body import MerchantLocationResponseBody  # noqa: E501
...
class TestMerchantLocationResponseBody(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MerchantLocationResponseBody:
        """Test MerchantLocationResponseBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MerchantLocationResponseBody`
        """
        model = MerchantLocationResponseBody()  # noqa: E501
        if include_optional:
            return MerchantLocationResponseBody(
                merchant_location = mx_platform_python.models.merchant_location_response.MerchantLocationResponse(
