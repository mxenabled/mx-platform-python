...
from mx_platform_python.models.widget_response_body import WidgetResponseBody  # noqa: E501
...
class TestWidgetResponseBody(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WidgetResponseBody:
        """Test WidgetResponseBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WidgetResponseBody`
        """
        model = WidgetResponseBody()  # noqa: E501
        if include_optional:
            return WidgetResponseBody(
                widget_url = mx_platform_python.models.widget_response.WidgetResponse(
                    type = 'connect_widget', 
