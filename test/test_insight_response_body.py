...
from mx_platform_python.models.insight_response_body import InsightResponseBody  # noqa: E501

class TestInsightResponseBody(unittest.TestCase):
    """InsightResponseBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InsightResponseBody:
        """Test InsightResponseBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InsightResponseBody`
        """
        model = InsightResponseBody()  # noqa: E501
        if include_optional:
            return InsightResponseBody(
                insight = mx_platform_python.models.insight_response.InsightResponse(
    ...
    def testInsightResponseBody(self):
        """Test InsightResponseBody"""
