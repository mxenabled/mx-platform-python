...
from mx_platform_python.models.goals_response_body import GoalsResponseBody  # noqa: E501

class TestGoalsResponseBody(unittest.TestCase):
    """GoalsResponseBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoalsResponseBody:
        ...
        # uncomment below to create an instance of `GoalsResponseBody`
        """
        model = GoalsResponseBody()  # noqa: E501
        if include_optional:
    ...
    def testGoalsResponseBody(self):
        """Test GoalsResponseBody"""
