...
from mx_platform_python.models.ach_response import ACHResponse  # noqa: E501
...
class TestACHResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ACHResponse:
        """Test ACHResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ACHResponse`
        """
        model = ACHResponse()  # noqa: E501
        if include_optional:
            return ACHResponse(
