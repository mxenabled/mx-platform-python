...
from mx_platform_python.models.member_update_request import MemberUpdateRequest  # noqa: E501
...
class TestMemberUpdateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MemberUpdateRequest:
        """Test MemberUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MemberUpdateRequest`
        """
        model = MemberUpdateRequest()  # noqa: E501
        if include_optional:
