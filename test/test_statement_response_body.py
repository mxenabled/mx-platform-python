...
from mx_platform_python.models.statement_response_body import StatementResponseBody  # noqa: E501
...
class TestStatementResponseBody(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StatementResponseBody:
        """Test StatementResponseBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatementResponseBody`
        """
        model = StatementResponseBody()  # noqa: E501
        if include_optional:
            return StatementResponseBody(
                statement = mx_platform_python.models.statement_response.StatementResponse(
