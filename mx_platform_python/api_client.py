...
from mx_platform_python import rest
from mx_platform_python.configuration import Configuration
from mx_platform_python.exceptions import ApiTypeError, ApiValueError, ApiException
from mx_platform_python.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = MxPlatformApi()
        api_instance.aggregate_member  # this is an instance of the class Endpoint
        api_instance.aggregate_member()  # this invokes api_instance.aggregate_member.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.aggregate_member.callable or self.callable in this class
