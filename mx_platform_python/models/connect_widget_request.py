...
class ConnectWidgetRequest(BaseModel):
    ...
    enable_app2app: Optional[StrictBool] = Field(None, description="This indicates whether OAuth app2app behavior is enabled for institutions that support it. Defaults to `true`. When set to `false`, the widget will **not** direct the end user to the institution's mobile application. This setting is not persistent. This setting currently only affects Chase institutions. ")
    ...
    __properties = ["client_redirect_url", "color_scheme", "current_institution_code", "current_member_guid", "disable_background_agg", "disable_institution_search", "enable_app2app", "include_identity", "include_transactions", "is_mobile_webview", "mode", "oauth_referral_source", "ui_message_version", "ui_message_webview_url_scheme", "update_credentials"]
