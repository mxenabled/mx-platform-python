...
class NotificationsResponseBody(BaseModel):
    ...
    """
    notifications: Optional[conlist(NotificationResponse)] = None
    __properties = ["notifications"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NotificationsResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NotificationsResponseBody:
        """Create an instance of NotificationsResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NotificationsResponseBody.parse_obj(obj)

        _obj = NotificationsResponseBody.parse_obj({
            "notifications": [NotificationResponse.from_dict(_item) for _item in obj.get("notifications")] if obj.get("notifications") is not None else None
        })
        return _obj
