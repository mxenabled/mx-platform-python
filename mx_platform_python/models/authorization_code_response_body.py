...
class AuthorizationCodeResponseBody(BaseModel):
    ...
    """
    authorization_code: Optional[AuthorizationCodeResponse] = None
    ...
    def from_dict(cls, obj: dict) -> AuthorizationCodeResponseBody:
        ...
        _obj = AuthorizationCodeResponseBody.parse_obj({
            "authorization_code": AuthorizationCodeResponse.from_dict(obj.get("authorization_code")) if obj.get("authorization_code") is not None else None
        })
        return _obj
