...
class TokenResponseBody(BaseModel):
    ...
    TokenResponseBody
    """
    tokens: Optional[conlist(TokenResponse)] = None
    __properties = ["tokens"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TokenResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TokenResponseBody:
        """Create an instance of TokenResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TokenResponseBody.parse_obj(obj)

        _obj = TokenResponseBody.parse_obj({
