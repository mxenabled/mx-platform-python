...
class MemberElements(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MemberElements:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MemberElements:
        """Create an instance of MemberElements from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MemberElements.parse_obj(obj)

        _obj = MemberElements.parse_obj({
