...
class InsightResponse(BaseModel):
    ...
    has_associated_categories: Optional[StrictBool] = None
    ...
    def to_dict(self):
        ...
        # set to None if has_associated_categories (nullable) is None
        # and __fields_set__ contains the field
        if self.has_associated_categories is None and "has_associated_categories" in self.__fields_set__:
            _dict['has_associated_categories'] = None
    ...
    def from_dict(cls, obj: dict) -> InsightResponse:
        ...
        _obj = InsightResponse.parse_obj({
            ...
            "has_associated_categories": obj.get("has_associated_categories"),
