...
class InstitutionResponse(BaseModel):
    ...
    __properties = ["code", "forgot_password_url", "forgot_username_url", "instructional_text", "instructional_text_steps", "is_disabled_by_client", "iso_country_code", "medium_logo_url", "name", "small_logo_url", "supports_account_identification", "supports_account_statement", "supports_account_verification", "supports_oauth", "supports_tax_document", "supports_transaction_history", "trouble_signing_in_url", "url"]
    ...
    def to_dict(self):
        ...
        # set to None if instructional_text_steps (nullable) is None
        # and __fields_set__ contains the field
        if self.instructional_text_steps is None and "instructional_text_steps" in self.__fields_set__:
            _dict['instructional_text_steps'] = None

        # set to None if is_disabled_by_client (nullable) is None
        # and __fields_set__ contains the field
        if self.is_disabled_by_client is None and "is_disabled_by_client" in self.__fields_set__:
            _dict['is_disabled_by_client'] = None
    ...
    def from_dict(cls, obj: dict) -> InstitutionResponse:
        ...
        _obj = InstitutionResponse.parse_obj({
            ...
            "instructional_text_steps": obj.get("instructional_text_steps"),
            "is_disabled_by_client": obj.get("is_disabled_by_client"),
