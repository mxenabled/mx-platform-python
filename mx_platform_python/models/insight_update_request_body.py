...
class InsightUpdateRequestBody(BaseModel):
    ...
    """
    insight: Optional[InsightUpdateRequest] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightUpdateRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightUpdateRequestBody:
        """Create an instance of InsightUpdateRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightUpdateRequestBody.parse_obj(obj)

        _obj = InsightUpdateRequestBody.parse_obj({
            "insight": InsightUpdateRequest.from_dict(obj.get("insight")) if obj.get("insight") is not None else None
        })
        return _obj
