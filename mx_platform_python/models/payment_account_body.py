...
class PaymentAccountBody(BaseModel):
    ...
    PaymentAccountBody
    """
    payment_account: Optional[PaymentAccountBodyPaymentAccount] = None
    __properties = ["payment_account"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymentAccountBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymentAccountBody:
        """Create an instance of PaymentAccountBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymentAccountBody.parse_obj(obj)

        _obj = PaymentAccountBody.parse_obj({
            "payment_account": PaymentAccountBodyPaymentAccount.from_dict(obj.get("payment_account")) if obj.get("payment_account") is not None else None
        })
        return _obj
