...
class RewardsResponseBody(BaseModel):
    ...
    RewardsResponseBody
    """
    rewards: Optional[conlist(RewardsResponseBodyRewardsInner)] = None
    ...
    def from_dict(cls, obj: dict) -> RewardsResponseBody:
        ...
        _obj = RewardsResponseBody.parse_obj({
            "rewards": [RewardsResponseBodyRewardsInner.from_dict(_item) for _item in obj.get("rewards")] if obj.get("rewards") is not None else None,
