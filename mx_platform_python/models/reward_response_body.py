...
class RewardResponseBody(BaseModel):
    ...
    RewardResponseBody
    """
    reward: Optional[RewardsResponseBodyRewardsInner] = None
    __properties = ["reward"]
    ...
    def from_dict(cls, obj: dict) -> RewardResponseBody:
        ...
        _obj = RewardResponseBody.parse_obj({
            "reward": RewardsResponseBodyRewardsInner.from_dict(obj.get("reward")) if obj.get("reward") is not None else None
        })
        return _obj
