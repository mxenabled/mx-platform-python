...
class TokenResponse(BaseModel):
    ...
    TokenResponse
    """
    payment_processor_guid: Optional[StrictStr] = None
    expires_at: Optional[StrictStr] = None
    access_token: Optional[StrictStr] = None
    active: Optional[StrictBool] = None
    __properties = ["payment_processor_guid", "expires_at", "access_token", "active"]
    ...
    def from_dict(cls, obj: dict) -> TokenResponse:
        ...
        _obj = TokenResponse.parse_obj({
            "payment_processor_guid": obj.get("payment_processor_guid"),
