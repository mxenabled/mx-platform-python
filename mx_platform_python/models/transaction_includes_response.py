...
from mx_platform_python.models.transaction_includes_response_all_of_classification import TransactionIncludesResponseAllOfClassification
...
class TransactionIncludesResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionIncludesResponse:
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of repeating_transaction
        if self.repeating_transaction:
            _dict['repeating_transaction'] = self.repeating_transaction.to_dict()
        ...
        # and __fields_set__ contains the field
        if self.geolocation is None and "geolocation" in self.__fields_set__:
            _dict['geolocation'] = None

        # set to None if merchant (nullable) is None
        # and __fields_set__ contains the field
        if self.merchant is None and "merchant" in self.__fields_set__:
            _dict['merchant'] = None

        # set to None if repeating_transaction (nullable) is None
        # and __fields_set__ contains the field
        if self.repeating_transaction is None and "repeating_transaction" in self.__fields_set__:
            _dict['repeating_transaction'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> TransactionIncludesResponse:
        """Create an instance of TransactionIncludesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionIncludesResponse.parse_obj(obj)

        _obj = TransactionIncludesResponse.parse_obj({
            ...
            "classification": TransactionIncludesResponseAllOfClassification.from_dict(obj.get("classification")) if obj.get("classification") is not None else None,
            "geolocation": TransactionIncludesResponseAllOfGeolocation.from_dict(obj.get("geolocation")) if obj.get("geolocation") is not None else None,
            "merchant": TransactionIncludesResponseAllOfMerchant.from_dict(obj.get("merchant")) if obj.get("merchant") is not None else None,
            "repeating_transaction": TransactionIncludesResponseAllOfRepeatingTransaction.from_dict(obj.get("repeating_transaction")) if obj.get("repeating_transaction") is not None else None
        })
        return _obj
