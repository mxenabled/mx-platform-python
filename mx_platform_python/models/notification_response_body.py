...
class NotificationResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NotificationResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NotificationResponseBody:
        """Create an instance of NotificationResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NotificationResponseBody.parse_obj(obj)

        _obj = NotificationResponseBody.parse_obj({
            "notification": NotificationResponse.from_dict(obj.get("notification")) if obj.get("notification") is not None else None
        })
        return _obj
