...
class MicrodepositResponseBodyMicroDepositInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MicrodepositResponseBodyMicroDepositInner:
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.verified_at is None and "verified_at" in self.__fields_set__:
            _dict['verified_at'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> MicrodepositResponseBodyMicroDepositInner:
        """Create an instance of MicrodepositResponseBodyMicroDepositInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MicrodepositResponseBodyMicroDepositInner.parse_obj(obj)

        _obj = MicrodepositResponseBodyMicroDepositInner.parse_obj({
