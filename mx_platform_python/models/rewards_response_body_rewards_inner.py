...
class RewardsResponseBodyRewardsInner(BaseModel):
    """
    ...
    __properties = ["account_guid", "member_guid", "user_guid", "balance_type", "balance", "created_at", "description", "expires_on", "guid", "unit_type", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RewardsResponseBodyRewardsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RewardsResponseBodyRewardsInner:
        """Create an instance of RewardsResponseBodyRewardsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RewardsResponseBodyRewardsInner.parse_obj(obj)

        _obj = RewardsResponseBodyRewardsInner.parse_obj({
