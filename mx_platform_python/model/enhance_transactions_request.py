...
class EnhanceTransactionsRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, description, id, *args, **kwargs):  # noqa: E501
        """EnhanceTransactionsRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            extended_transaction_type (str): [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, description, id, *args, **kwargs):  # noqa: E501
        """EnhanceTransactionsRequest - a model defined in OpenAPI
