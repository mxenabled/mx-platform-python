...
class TaggingUpdateRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, tag_guid, *args, **kwargs):  # noqa: E501
        """TaggingUpdateRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, tag_guid, *args, **kwargs):  # noqa: E501
        """TaggingUpdateRequest - a model defined in OpenAPI
